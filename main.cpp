...
void runCifar10()
{
	...
	nlrate.push_back(0.005f);    nMomentum.push_back(0.90f);  epoCount.push_back(300);
	nlrate.push_back(0.004f);    nMomentum.push_back(0.90f);  epoCount.push_back(10);
	nlrate.push_back(0.003f);    nMomentum.push_back(0.90f);  epoCount.push_back(10);
	nlrate.push_back(0.002f);    nMomentum.push_back(0.90f);  epoCount.push_back(10);
	nlrate.push_back(0.001f);    nMomentum.push_back(0.90f);  epoCount.push_back(10);
	nlrate.push_back(0.0009f);   nMomentum.push_back(0.90f);  epoCount.push_back(10);
	nlrate.push_back(0.0008f);   nMomentum.push_back(0.90f);  epoCount.push_back(10);
	nlrate.push_back(0.0007f);   nMomentum.push_back(0.90f);  epoCount.push_back(10);
	nlrate.push_back(0.0006f);   nMomentum.push_back(0.90f);  epoCount.push_back(10);
	nlrate.push_back(0.0005f);   nMomentum.push_back(0.90f);  epoCount.push_back(10);
	nlrate.push_back(0.0004f);   nMomentum.push_back(0.90f);  epoCount.push_back(10);
	nlrate.push_back(0.0003f);   nMomentum.push_back(0.90f);  epoCount.push_back(10);
	nlrate.push_back(0.0002f);   nMomentum.push_back(0.90f);  epoCount.push_back(10);
	nlrate.push_back(0.0001f);   nMomentum.push_back(0.90f);  epoCount.push_back(10);
	nlrate.push_back(0.00001f);   nMomentum.push_back(0.90f);  epoCount.push_back(10);
	nlrate.push_back(0.000001f);   nMomentum.push_back(0.90f);  epoCount.push_back(10);
	start = clock();
	cuTrainNetwork(trainX, trainY, testX, testY, batch, ImgSize - crop, nclasses, nlrate, nMomentum, epoCount, handle);
	end = clock();
