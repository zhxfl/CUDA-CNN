...
dataAugmentation/%.o: ../dataAugmentation/%.cu
	...
	/usr/local/cuda-6.5/bin/nvcc -I/usr/local/cuda-6.5/NVIDIA_CUDA-6.5_Samples/common/inc/ -O3 -gencode arch=compute_50,code=sm_50  -odir "dataAugmentation" -M -o "$(@:%.o=%.d)" "$<"
